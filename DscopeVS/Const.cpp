...
namespace Const
{
	...
	extern const U8 pulseArray[Npulses] = { 1, 1, 1, 0, 1, 0, 0, 0, 1, 0 };		//pulse sequence, where 1 (0) indicates the presence (absence) of a pulse
	...
	extern const U16 Npixels = 2;					//Number of pixels per line to acquire
};