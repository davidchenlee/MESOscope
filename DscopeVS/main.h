...
#define AO_dt 2*us					// Analog output time increament in us. AO takes more than 1us to read and write the data
...
static const uint16_t calibrateAOtiming = 43 * tick;	//fine-tune the AO timing. This equals the number of ticks the FGPA needs to read and write the data.
...
static const uint16_t calibrateDOtiming = 5 * tick; //fine-tune the DO timing. The same idea as with AO
