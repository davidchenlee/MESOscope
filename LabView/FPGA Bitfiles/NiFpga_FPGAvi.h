 ...
 */
static const char* const NiFpga_FPGAvi_Signature = "B6FD64A8BFC9BA11B98299BFBA70A6E1";
...
typedef enum
{
   ...
   NiFpga_FPGAvi_ControlBool_LineclockInputSelector = 0x4E,
   NiFpga_FPGAvi_ControlBool_PcTrigger = 0x7A,
   NiFpga_FPGAvi_ControlBool_PhotocounterInputSelector = 0x22,
...
typedef enum
{
   ...
   NiFpga_FPGAvi_ControlI16_Npreframes = 0x36,
...
typedef enum
{
   ...
   NiFpga_FPGAvi_ControlU32_PockelsFrameDelay_tick = 0x2C,
   NiFpga_FPGAvi_ControlU32_PostsequenceTimer_tick = 0x28,
   NiFpga_FPGAvi_ControlU32_PreframeclockDelay_tick = 0x1C,
   NiFpga_FPGAvi_ControlU32_RescanGalvoDelay_tick = 0x38,
   NiFpga_FPGAvi_ControlU32_ScanGalvoDelay_tick = 0x30,
   NiFpga_FPGAvi_ControlU32_ZstageTrigDelay_tick = 0x24,
