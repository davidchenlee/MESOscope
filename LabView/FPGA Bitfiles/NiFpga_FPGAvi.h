 ...
 */
static const char* const NiFpga_FPGAvi_Signature = "2880CB623554353FAE83A42636D9746B";
...
typedef enum
{
   NiFpga_FPGAvi_ControlU16_FIFOtimeout_tick = 0x5E,
   ...
   NiFpga_FPGAvi_ControlU16_SyncDOtoAOtick = 0x66,
