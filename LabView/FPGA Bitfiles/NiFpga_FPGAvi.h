 ...
 */
static const char* const NiFpga_FPGAvi_Signature = "4DEC726757CCC2AD26A2894B1A699245";

typedef enum
{
   NiFpga_FPGAvi_ControlBool_EnableFIFO = 0x3A,
   NiFpga_FPGAvi_ControlBool_FIFOINtrigger = 0x6A,
   NiFpga_FPGAvi_ControlBool_FlushTrigger = 0x1A,
   NiFpga_FPGAvi_ControlBool_LinegateTrigger = 0x2E,
   NiFpga_FPGAvi_ControlBool_Pockels1_EnableManualControl = 0x12,
   NiFpga_FPGAvi_ControlBool_RS_ON_OFF = 0x42,
   NiFpga_FPGAvi_ControlBool_Shutter1 = 0x36,
   NiFpga_FPGAvi_ControlBool_Shutter2 = 0x32,
...
typedef enum
{
   NiFpga_FPGAvi_ControlU8_LineclockInputSelector = 0x22,
   NiFpga_FPGAvi_ControlU8_PhotoncounterInputSelector = 0x26,
...
typedef enum
{
   ...
   NiFpga_FPGAvi_ControlU16_NlinesAll = 0x5A,
   NiFpga_FPGAvi_ControlU16_NlinesPerFrame = 0x2A,
   NiFpga_FPGAvi_ControlU16_NlinesPerFramePlusSkips = 0x1E,
   NiFpga_FPGAvi_ControlU16_SyncAODOtoLinegate_tick = 0x56,
