...
{
public:
	const POSITION2 mStageInitialBladePosXY{ -57. * mm, 8. * mm };	//Position the stages in front oh the vibratome's blade
	const double mStageFinalBladePosY{ 30. * mm };					//Final position of the Y-stage after slicing
