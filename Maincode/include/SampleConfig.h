...
public:
	...
	double mSurfaceZ{ -1 };
	const double mBladeFocalplaneOffsetZ{ -0.025 * mm };	// <----CHANGED from 1.620 mm //Positive distance if the blade is higher than the microscope's focal plane; negative otherwise
