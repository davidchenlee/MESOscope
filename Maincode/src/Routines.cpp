...
//SAMPLE PARAMETERS
double3 stackCenterXYZ{ 52.792 * mm, 17.000 * mm, 18.078 * mm };//Beads 74, 78
...
const ChannelList channelListBeads{ {{ "DAPI", 750, 40. * mW, 0. * mWpum }, { "GFP", 920, 45. * mW, 0. * mWpum }, { "TDT", 1040, 12. * mW, 0. * mWpum }} };	//4um beads
