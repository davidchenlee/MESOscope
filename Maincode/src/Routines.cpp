...
//SAMPLE PARAMETERS
double3 stackCenterXYZ{ 52.792 * mm, 17.000 * mm, 18.073 * mm };//Beads 73, 79
...
const ChannelList channelListBeads{ {{ "DAPI", 750, 35. * mW, 0. * mWpum }, { "GFP", 920, 45. * mW, 0. * mWpum }, { "TDT", 1040, 12. * mW, 0. * mWpum }} };	//4um beads
