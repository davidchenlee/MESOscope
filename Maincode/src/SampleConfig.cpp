...
const extern POSITION3 g_stackCenterXYZ{ ((40.+52.)/2 + 0) * mm, ((21.+28.)/2 + 0.000)* mm, (19.990 + 0.000) * mm };//For Liver
//const extern POSITION3 g_stackCenterXYZ{ (48.000 ) * mm, (26.150 - 0.300 ) * mm, (19.990 + 0.000) * mm };//For Liver
