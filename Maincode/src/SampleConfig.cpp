...
//const extern POSITION3 g_stackCenterXYZ{ ((40.+52.)/2 + 0) * mm, ((21.+28.)/2 + 0.000)* mm, (19.860 + 0.000) * mm };//For Liver
const extern POSITION3 g_stackCenterXYZ{ (46.000 ) * mm, (26.050 + 0.1 ) * mm, (19.860 + 0.000) * mm };//For Liver
