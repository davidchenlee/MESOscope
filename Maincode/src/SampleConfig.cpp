...
const extern POSITION3 g_stackCenterXYZ{ (47.600 - 0*0.300) * mm, (26.050 - 0.500) * mm, (19.825 + 0.000) * mm };//For Liver
...
#else//singlebeam
const extern Sample g_currentSample{ "Liver", "SiliconeMineralOil5050", "1.49", ContainerPosLimit,  {{{ "TDT", 1040, 30. * mW, 160. * um, 2 },
																									  { "DAPI", 750, 6.5 * mW, 120. * um, 2 }}} };
