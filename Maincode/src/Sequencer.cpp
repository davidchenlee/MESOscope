...
//{a, b}, a = +1, move up; b = +1, move right
int2 nextMove(const int2 imageBrightnessUnbalance)
{
	const int a{ 1 };//+1 for counterclockwise, -1 for clockwise

	switch (imageBrightnessUnbalance.at(0))
	{
	case 1://Top brighter => move right
		switch (imageBrightnessUnbalance.at(1))
		{
		case 1://Right brighter => move down
			return { -a, a };
		case -1://Left brighter => move up
			return { a, a };
		case 0://Neither right or left brighter => neither move right or left
			return { 0, a };
		}
	case -1://bottom brighter => move left
		switch (imageBrightnessUnbalance.at(1))
		{
		case 1://Right brighter => move down
			return { -a, -a };
	...
	case 0://neither top or bottom brighter => neither move up or down
		switch (imageBrightnessUnbalance.at(1))
		{
		case 1://Right brighter => move down
			return { -a, 0 };
...
{
	switch (nextMove.at(0))
	{
	case 1:
		switch (nextMove.at(1))
		{
		case 1:
			std::cout << "Move up and right\n";
			break;
		case -1:
			std::cout << "Move up and left\n";
			break;
		case 0:
			std::cout << "Move up\n";
			break;
	...
	case -1:
		...
		{
		case 1:
			std::cout << "Move down and right\n";
			break;
		case -1:
			std::cout << "Move down and left\n";
			break;
		case 0:
			std::cout << "Move down\n";
			break;
