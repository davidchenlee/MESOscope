...
U16 float2fix(float n)
{
	const int FIXED_BIT = 14; //Number of decimal digits. MUST match the LV implementation: a U16 is split into 2 integer digits + 14 decimal digits
