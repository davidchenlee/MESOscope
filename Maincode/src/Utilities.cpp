...
void TiffU8::flattenFieldLinear(const double scaleFactor, const int lowerChan, const int higherChan)
{
	...
	std::vector<double> vec_upscalingFactors(g_nChanPMT, 1.0);							//Vector of upscaling factors
